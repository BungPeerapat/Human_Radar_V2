...
static constexpr uint16_t RADAR_RX_BUF_SIZE   = 512;    // UART RX buffer (default 256 too tight at 256000 baud)
static constexpr uint32_t RADAR_FRAME_TIMEOUT  = 200;    // ms, reset state if frame incomplete

// Data frame structure: [Header 4B] [Target1 8B] [Target2 8B] [Target3 8B] [Footer 2B]
